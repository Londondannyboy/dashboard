...
interface Article {
  ...
  excerpt?: string
  country_code?: string
  url?: string // Optional external URL for hyperlinks
}

export interface ArticlesSectionProps {
  userId: string | null
  apiEndpoint?: string // Allow customization of API endpoint
}
...
export function ArticlesSection({ userId, apiEndpoint = '/api/articles/recommended' }: ArticlesSectionProps) {
      ...
      <div className="p-4 space-y-2">
        {loading ? (
          ...
          articles.map(article => {
            ...
            // Use external URL if provided, otherwise use internal article route
            const href = article.url || `/articles/${article.slug}`
