...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!agency) {
    return {
      title: 'Agency Not Found | Rainmakrr Agency',
    }
  }

  return {
    title: `${agency.name} | Startup Recruitment Agency UK`,
    description: agency.description || `${agency.name} - Leading startup recruitment agency profile`,
    keywords: `${agency.name}, startup recruitment, tech recruitment, ${agency.headquarters || 'UK'}`,
  }
}
...
export default async function AgencyPage({ params }: PageProps) {
  ...
  const anchorTexts = [
    "View all startup recruitment agencies",
    "Top tech recruiters UK",
    "Best startup agencies",
    "Complete list of scale-up recruiters",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">Your source for startup recruitment insights.</p>
            </div>
            <div>
