...
export const metadata: Metadata = {
  title: 'Startup Recruitment Agencies Directory UK | Tech & Scale-Up Recruiters',
  description: 'Comprehensive directory of leading startup recruitment agencies in the UK. Find specialist recruiters for tech, scale-up, and high-growth positions in London and across the UK.',
  keywords: 'startup recruitment agencies, tech recruiters UK, scale-up recruitment, startup jobs London, venture-backed hiring',
}
      ...
      <div className="hero-gradient pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Startup Recruitment Agencies
          </h1>
          <p className="text-xl text-violet-100 max-w-3xl">
            Comprehensive directory of leading recruitment agencies specialising in startup, tech, and scale-up positions across the UK.
          </p>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            Finding the Right Startup Recruitment Agency
          </h2>
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="mb-4">
              Choosing the right <strong>startup recruitment agency</strong> is crucial for both candidates
              and hiring organisations. The best agencies have deep networks in the startup ecosystem and
              understand the unique challenges of hiring for fast-growing companies.
            </p>
            <p className="mb-4">
              When selecting an agency, consider their specialisation (early-stage vs scale-up), their client base
              (sector focus, funding stage), and their track record in your target market. Many agencies in our
              directory have been placing candidates at UK&apos;s most successful startups for years.
            </p>
            <p>
              Whether you&apos;re seeking your first startup role or looking to hire exceptional talent for your
              venture-backed company, the agencies in our directory represent the best of UK startup recruitment.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-bold mb-4">Rainmakrr Agency</h3>
              <p className="text-gray-400 text-sm">Your source for startup recruitment insights and agency directory.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/agencies" className="text-gray-400 hover:text-white">Top Startup Agencies</Link></li>
                <li><Link href="/articles" className="text-gray-400 hover:text-white">Industry News</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} Rainmakrr Agency. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
