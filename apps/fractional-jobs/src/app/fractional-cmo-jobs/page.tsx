...
const cmoJobs_HARDCODED: HardcodedJob[] = [
  {
    id: 1,
...
export default function CMOPage() {
  ...
  const cmoJobs = cmoJobs_HARDCODED
      ...
      <main className="pt-24 pb-20">
        ...
        <section className="py-12 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="flex justify-between items-center mb-8">
              ...
              <Link href="/fractional-cmo-jobs" className="text-violet-700 hover:text-violet-900 font-semibold">
        ...
        <section className="py-16 px-4 bg-violet-900">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/fractional-cmo-jobs" className="bg-white text-violet-900 hover:bg-gray-100 font-bold px-8 py-4 rounded-lg transition inline-block">
              Browse CMO Roles
            </Link>
          </div>
        </section>
