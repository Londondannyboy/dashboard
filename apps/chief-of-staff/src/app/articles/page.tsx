...
export const metadata: Metadata = {
  title: 'Chief of Staff Articles & Guides | Executive Assistant Career Insights UK',
  description: 'Browse articles on chief of staff careers, executive assistant recruitment, salary guides, and industry insights. Expert advice for C-suite support professionals in the UK.',
  keywords: 'chief of staff articles, executive assistant career advice, CoS salary guide, EA recruitment insights, C-suite support UK',
}
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/articles" className="text-blue-600 font-medium">Articles</Link>
      ...
      <section className="bg-white pt-24 pb-12 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600">Browse our complete collection of Chief of Staff and Executive Assistant insights</p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Chief of Staff Quest. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
