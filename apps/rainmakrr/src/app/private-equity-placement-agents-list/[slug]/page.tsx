      ...
      <main className="flex-1 pt-16">
        ...
        <section className="relative py-16 px-6">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <span className="inline-block px-3 py-1 bg-blue-500/20 text-blue-300 text-xs font-semibold rounded-full mb-4">
              Placement Agent
            </span>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {tags.industries.map(tag => (
                <span key={tag} className="px-3 py-1 bg-indigo-500/20 text-indigo-300 rounded-full text-sm font-medium border border-indigo-500/30">
                  {tag}
                </span>
              ))}
