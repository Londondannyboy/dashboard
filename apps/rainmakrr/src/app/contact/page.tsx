          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white/[0.03] border border-white/10 rounded-xl p-6">
                ...
                <a href="mailto:hello@rainmakrr.com" className="text-blue-400 hover:text-blue-300 transition">
                  hello@rainmakrr.com
                </a>
              </div>
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-xl p-6">
                ...
                <a href="mailto:listings@rainmakrr.com" className="text-indigo-400 hover:text-indigo-300 transition">
                  listings@rainmakrr.com
                </a>
              </div>
            </div>

            <div className="bg-gradient-to-br from-blue-900/30 to-indigo-900/30 border border-blue-500/20 rounded-2xl p-8">
              ...
              <div className="space-y-4 text-gray-400 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-blue-500/30 rounded flex items-center justify-center mt-0.5">
