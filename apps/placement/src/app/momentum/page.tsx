        ...
        <section className="py-12 px-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-400 max-w-3xl">
              ...
              in the placement agent ecosystem.
            </p>
          </div>
        </section>
        ...
        <section className="py-12 px-6 border-b border-white/10">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div>
                <h2 className="text-xl font-bold mb-4">Deal Timeline</h2>
                <DealTimeline3D
                  height="400px"
                  maxDeals={15}
            ...
            <div className="space-y-8">
                  ...
                  {loading ? (
                    ...
                    articles.slice(0, 5).map(article => (
                      <Link
                        key={article.id}
                        href={`/${article.slug}`}
                        className="block bg-white/[0.03] border border-white/10 rounded-xl p-4 hover:border-blue-500/30 transition"
                      >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link
                    href="/ecosystem"
                    className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 text-center hover:bg-blue-500/20 transition"
                  >
                    ...
                    <span className="text-sm font-medium text-blue-300">Network</span>
                  </Link>
                  <Link
                    href="/visualizations"
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-indigo-300">Charts</span>
                  </Link>
                </div>
              </div>
            </div>
