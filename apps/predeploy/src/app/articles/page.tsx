...
export const metadata: Metadata = {
  title: 'Forward Deployed Engineer Articles & Guides | FDE Career Insights UK',
  description: 'Browse articles on forward deployed engineer careers, FDE recruitment, salary guides, and industry insights. Expert advice for technical professionals in the UK.',
  keywords: 'forward deployed engineer articles, FDE career advice, forward deployed engineer salary guide, FDE recruitment insights, technical recruitment UK',
}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white pt-24 pb-12 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-600">Browse our complete collection of Forward Deployed Engineer and FDE insights</p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Predeploy Quest. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
