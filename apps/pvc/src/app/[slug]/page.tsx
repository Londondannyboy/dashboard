...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Get content - either from content field or payload
                ...
                {relatedArticles.map((related) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group"
                    >
                      <div className="h-40 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-xl mb-3 overflow-hidden">
                        {relatedThumb ? (
                          <img
                            src={relatedThumb}
                            alt={related.title}
                          ...
                          <div className="w-full h-full flex items-center justify-center">
                            <svg className="w-10 h-10 text-indigo-400/30" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <h3 className="text-sm font-semibold group-hover:text-indigo-400 transition line-clamp-2">
                        {related.title}
                      </h3>
                    </Link>
                  )
