  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0a0f] text-white">
      ...
      <main className="flex-1 pt-16">
              ...
              {REGIONS.map((region) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl group-hover:text-indigo-400 transition">
                        {region.name}
                      </h3>
                    </div>
                  </div>
        ...
        <section className="px-6 py-16 bg-gradient-to-br from-indigo-900/10 to-purple-900/10 border-y border-white/10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              ...
              from New York and London to Singapore and São Paulo.
            </p>
            ...
            <div className="grid md:grid-cols-4 gap-4 text-center">
              ...
              <div className="bg-white/[0.03] rounded-xl p-6">
                <div className="text-3xl font-bold text-pink-400 mb-1">$500B+</div>
