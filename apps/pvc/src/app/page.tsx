...
function getCompanyImage(company: Company): { url: string | null; type: 'logo' | 'image' | 'placeholder' } {
...
export default async function HomePage() {
  ...
  // Fetch all VC/PE firms (placement_agent type represents firms in this context)
      ...
      <main className="flex-1 pt-16">
        ...
        {leadArticle ? (
          ...
          <section className="relative overflow-hidden py-20 px-6">
            ...
            <div className="max-w-6xl mx-auto relative z-10 text-center">
              <h1 className="text-5xl md:text-7xl font-black mb-4">Venture Capital & Startup Funding</h1>
              <p className="text-xl md:text-2xl text-indigo-300 font-medium">VC Firm Rankings & Market Intelligence</p>
            </div>
          </section>
        )}
        ...
        <section className="bg-gradient-to-r from-slate-900 to-indigo-950 py-12 text-center">
          <div className="max-w-6xl mx-auto px-6">
            <h1 className="text-3xl md:text-4xl font-black mb-2">Venture Capital & Startup Funding News</h1>
            <p className="text-lg text-indigo-300 font-medium">VC Firm Rankings, Funding Rounds & Market Intelligence</p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-12">
          <p className="text-gray-400 leading-relaxed mb-10 max-w-4xl">
            Welcome to PVC Quest, your insider guide to <strong className="text-white">venture capital and startup funding</strong>.
            We track the top VC firms, funding rounds from seed to Series D+, fund performance, and market trends.
            Whether you're a founder raising capital, an LP evaluating VCs, or an investor tracking the startup ecosystem,
            PVC Quest delivers the intelligence you need to stay ahead.
          </p>
                  ...
                  <Link key={article.id} href={`/${article.slug}`} className="block group">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      {article.article_angle && (
                        <span className="bg-indigo-500/15 text-indigo-400 px-2 py-0.5 rounded text-xs font-semibold uppercase">
                    ...
                    <h3 className="font-bold text-lg group-hover:text-indigo-400 transition line-clamp-2">{article.title}</h3>
                    {article.excerpt && (
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
              <div>
                ...
                <h2 className="text-2xl font-black">PE & VC Firms Network</h2>
              </div>
            ...
            <div className="flex flex-wrap gap-6 mb-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span><strong className="text-white">{allCompanies.length}+</strong> <span className="text-gray-400">PE & VC Firms</span></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full" />
                <span><strong className="text-white">106</strong> <span className="text-gray-400">Entities</span></span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 bg-amber-500 rounded-full" />
                <span><strong className="text-white">599</strong> <span className="text-gray-400">Connections</span></span>
              </div>
            </div>
        ...
        <section className="bg-white/[0.03] py-16">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-center mb-8">Funding Timeline</h2>
            <DealTimeline3D
              height="400px"
              maxDeals={15}
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <h2 className="text-2xl font-bold mb-4 pb-3 border-b-4 border-indigo-600 inline-block">Latest News</h2>
          <p className="text-gray-500 mb-8">Stay informed with the latest VC funding rounds, startup news, and market insights.</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map(article => (
              <Link key={article.id} href={`/${article.slug}`} className="block group hover:-translate-y-1 transition-transform duration-300">
                ...
                <h3 className="font-bold text-lg group-hover:text-indigo-400 transition leading-snug mb-2">{article.title}</h3>
        ...
        {/* Full VC Firms Directory */}
        <section className="bg-white/[0.02] border-t border-white/10 py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl font-black mb-4 text-center">Top PE & VC Firms Directory</h2>
            <p className="text-gray-400 text-center mb-12 max-w-3xl mx-auto">
              Browse our comprehensive directory featuring top private equity and venture capital firms from around the world.
            </p>
                ...
                return (
                  ...
                  >
                    <div className="h-24 bg-gradient-to-br from-indigo-200 to-purple-200 relative">
                      {img.url && img.type === 'image' ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <span className="text-4xl font-black text-indigo-500 opacity-30">{company.name?.charAt(0)}</span>
                        </div>
                      )}
                    ...
                    <div className="p-5 pt-4">
                      <h3 className="font-bold group-hover:text-indigo-400 transition">{company.name}</h3>
            ...
            <p className="text-sm text-gray-500 text-center mt-10 max-w-3xl mx-auto leading-relaxed">
              Each of these top PE and VC firms brings unique strengths across different sectors and stages.
              From seed-stage specialists to growth equity giants, these firms have the capital and expertise to back the next generation of market leaders.
            </p>
          </div>
        </section>
          ...
          <section className="bg-white/[0.02] border-t border-white/10 py-24 px-6">
            <div className="max-w-5xl mx-auto">
              ...
              {sections.fee_structures.content?.standard_fees && (
                <div className="mb-12">
                  <h3 className="text-xl font-bold mb-6">Typical Funding Ranges</h3>
              ...
              {sections.fee_structures.content?.retainer_models && (
                <div className="mb-12">
                  <h3 className="text-xl font-bold mb-6">Investment Models</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    {sections.fee_structures.content.retainer_models.map((model: { type: string; monthly_retainer?: string; success_fee?: string; retainer_period?: string; note?: string }, i: number) => (
                      <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-6">
                        ...
                        <div className="text-sm text-gray-300 space-y-2">
                          {model.monthly_retainer && <p><strong>Typical Range:</strong> {model.monthly_retainer}</p>}
                          {model.success_fee && <p><strong>Equity:</strong> {model.success_fee}</p>}
              ...
              {sections.fee_structures.content?.example && (
                <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-xl p-8 text-center">
                  <h3 className="text-xl font-bold mb-5">Example: {sections.fee_structures.content.example.fund_size}</h3>
        ...
        <section className="bg-gradient-to-r from-indigo-600 to-purple-600 py-24 text-center">
          <div className="max-w-3xl mx-auto px-6">
            <h2 className="text-4xl font-black mb-5">Track the VC & Startup Ecosystem</h2>
            <p className="text-xl text-white/90 mb-10">
              Stay ahead with comprehensive intelligence on venture capital firms, startup funding rounds, fund performance, and market trends.
            </p>
            <Link
              href="/contact"
