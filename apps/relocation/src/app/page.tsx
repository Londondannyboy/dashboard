        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="text-xl font-bold">
              ...
              <span className="text-amber-500">Quest</span>
            </Link>
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-amber-500 font-semibold">Articles</Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <div className="flex gap-8">
              <Link href="/chat" className="text-gray-500 hover:text-white transition-colors">Chat</Link>
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-center text-gray-600 text-sm">
            AI-powered relocation guidance and expert content
          </div>
        </div>
      </footer>
    </main>
